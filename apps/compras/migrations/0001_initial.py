# Generated manually — reescritura completa del módulo compras
# Reemplaza el modelo EntradaInventario por OrdenCompra con cantidad_recibida
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True, db_constraint=False, null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="+", to="compras.ordencompra",
                    ),
                ),
                (
                    "tipo_equipo",
                    models.ForeignKey(
                        blank=True, db_constraint=False, null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="+", to="catalogo.tipoequipo",
                    ),
                ),
                (
                    "ubicacion",
                    models.ForeignKey(
                        blank=True, db_constraint=False, null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="+", to="catalogo.ubicacion",
                    ),
                ),
            ],
            options={
